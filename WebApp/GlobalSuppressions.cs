...
[assembly: SuppressMessage("Design", "CA1031:Не перехватывать исключения общих типов", Justification = "<Ожидание>", Scope = "member", Target = "~M:TodoListApp.WebApp.Service.TodoItemService.GetTasksByStatus(System.String,System.Int32,System.Int32)~System.Threading.Tasks.Task{System.Collections.Generic.List{TodoListApp.WebApp.Model.TodoItemModel}}")]
